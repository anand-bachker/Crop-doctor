import 'package:crop_disease_detection/screens/Paddy%20Crop/Management/sb_management.dart';
import 'package:crop_disease_detection/screens/Paddy%20Crop/Symptoms/sb_symptoms.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:google_fonts/google_fonts.dart';

class SBPage extends StatelessWidget {
  const SBPage({Key? key}) : super(key: key);
                  ...
                  children: [
                      ...
                      onTap: () {
                        Navigator.push(
                          context, MaterialPageRoute(
                              builder: (context) => const SBSymptoms()));
                      },
                      child: Container(
                        height: 200,
                        width: 160,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context, MaterialPageRoute(
                              builder: (context) => const SBManagement()));
                      },
                      child: Container(
                        height: 200,
                        width: 160,
