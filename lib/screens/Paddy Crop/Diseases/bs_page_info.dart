import 'package:crop_disease_detection/screens/Paddy%20Crop/Management/bs_management.dart';
import 'package:crop_disease_detection/screens/Paddy%20Crop/Symptoms/bs_symptoms.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:google_fonts/google_fonts.dart';

class BSPage extends StatelessWidget {
  const BSPage({Key? key}) : super(key: key);
                  ...
                  children: [
                      ...
                      onTap: () {
                        Navigator.push(
                          context, MaterialPageRoute(
                              builder: (context) => const BSSymptoms()));
                      },
                      child: Container(
                        height: 200,
                        width: 160,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context, MaterialPageRoute(
                              builder: (context) => const BSManagement()));
                      },
                      child: Container(
                        height: 200,
                        width: 160,
