...
const slidePage1Color = Color.fromARGB(255, 244, 255, 245);
const slidePage2Color = Color.fromARGB(255, 255, 216, 239);
const slidePage3Color = Color.fromARGB(255, 222, 227, 253);
